...
#### My approach
1) I took perspective transform of camera image
2) Transformed it to birds eye view
3) Used threshold for rock, terrain and obstacle
4) Converted them to rover-centric co-ordinates
5) Conevrted that to world co-ordinates
6) Lastly mapped them
...
Writing process_image consumed most of my time along with perception.py

In the end my pipeline is getting out of bound at 1709, which I am trying to solve.
